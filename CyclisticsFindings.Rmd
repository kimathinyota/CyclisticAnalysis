...
flextable(schema %>% mutate(completion_rate=round((total_rows-n_missing)/total_rows), 3))
```
...
htmlTableWidget(location_focus %>% select(community, member_percentage, total_riders, total_starts, total_ends))
#?arrange()
```
